...
public record RoundedRectangleRenderState(
    ...
    public RoundedRectangleRenderState(
        ...
        this(pipeline, TextureSetup.noTexture(), pose, x, y, width, height, color, color, radius, 0.0f, 0f, 0f, 0f, cornerMask, scissorArea, getBounds(x, y, width, height, pose, scissorArea));
    }
    ...
    public RoundedRectangleRenderState(
        ...
        this(pipeline, TextureSetup.noTexture(), pose, x, y, width, height, color, color2, radius, borderThickness, 0f, 0f, 0f, cornerMask, scissorArea, getBounds(x, y, width, height, pose, scissorArea));
    }
    ...
    public RoundedRectangleRenderState(
        ...
        this(pipeline, TextureSetup.noTexture(), pose, x, y, width, height, color, color2, radius, borderThickness, shadowBlur, shadowOffsetX, shadowOffsetY, cornerMask, scissorArea, getBounds(x, y, width, height, pose, scissorArea));
    }
    ...
    private void addVertex(VertexConsumer v, HaloVertexConsumer hv, float vx, float vy, float u, float vCoord) {
        ...
        hv.setColor2(color2);
        hv.setShadowProps(shadowBlur, shadowOffsetX, shadowOffsetY, cornerMask);
    }
